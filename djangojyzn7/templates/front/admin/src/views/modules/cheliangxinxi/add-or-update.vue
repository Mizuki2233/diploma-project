	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundSize":" 100% 100%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220730/cb2195540cde42b7abf14af25c15da3e.png) no-repeat  center bottom / cover","display":"flex","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="里程数(万公里)" prop="lichengshu">
					<el-input v-model="ruleForm.lichengshu" placeholder="里程数(万公里)" clearable  :readonly="ro.lichengshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="里程数(万公里)" prop="lichengshu">
					<el-input v-model="ruleForm.lichengshu" placeholder="里程数(万公里)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="最大载人量（人）" prop="zuidazairenliang">
					<el-input v-model="ruleForm.zuidazairenliang" placeholder="最大载人量（人）" clearable  :readonly="ro.zuidazairenliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="最大载人量（人）" prop="zuidazairenliang">
					<el-input v-model="ruleForm.zuidazairenliang" placeholder="最大载人量（人）" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="运货量（吨）" prop="yunhuoliang">
					<el-input v-model="ruleForm.yunhuoliang" placeholder="运货量（吨）" clearable  :readonly="ro.yunhuoliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="运货量（吨）" prop="yunhuoliang">
					<el-input v-model="ruleForm.yunhuoliang" placeholder="运货量（吨）" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="出发地(精确到市)" prop="chufadi">
					<el-input v-model="ruleForm.chufadi" placeholder="出发地(精确到市)" clearable  :readonly="ro.chufadi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="出发地(精确到市)" prop="chufadi">
					<el-input v-model="ruleForm.chufadi" placeholder="出发地(精确到市)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="每日租金（元）" prop="meirizujin">
					<el-input v-model="ruleForm.meirizujin" placeholder="每日租金（元）" clearable  :readonly="ro.meirizujin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="每日租金（元）" prop="meirizujin">
					<el-input v-model="ruleForm.meirizujin" placeholder="每日租金（元）" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				chufadi: [
					{ required: true, message: '出发地(精确到市)不能为空', trigger: 'blur' },
				],
				meirizujin: [
