	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundSize":" 100% 100%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220730/cb2195540cde42b7abf14af25c15da3e.png) no-repeat  center bottom / cover","display":"flex","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="车辆型号" prop="cheliangxinghao">
					<el-input v-model="ruleForm.cheliangxinghao" placeholder="车辆型号" clearable  :readonly="ro.cheliangxinghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="车辆型号" prop="cheliangxinghao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="里程数" prop="lichengshu">
					<el-input v-model="ruleForm.lichengshu" placeholder="里程数" clearable  :readonly="ro.lichengshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="里程数" prop="lichengshu">
					<el-input v-model="ruleForm.lichengshu" placeholder="里程数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="最大载人量" prop="zuidazairenliang">
					<el-input v-model="ruleForm.zuidazairenliang" placeholder="最大载人量" clearable  :readonly="ro.zuidazairenliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="最大载人量" prop="zuidazairenliang">
					<el-input v-model="ruleForm.zuidazairenliang" placeholder="最大载人量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="运货量" prop="yunhuoliang">
					<el-input v-model="ruleForm.yunhuoliang" placeholder="运货量" clearable  :readonly="ro.yunhuoliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="运货量" prop="yunhuoliang">
					<el-input v-model="ruleForm.yunhuoliang" placeholder="运货量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="每日租金" prop="meirizujin">
					<el-input v-model="ruleForm.meirizujin" placeholder="每日租金" clearable  :readonly="ro.meirizujin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="每日租金" prop="meirizujin">
					<el-input v-model="ruleForm.meirizujin" placeholder="每日租金" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.cailiaowenjian" label="材料文件" prop="cailiaowenjian">
					<file-upload
						tip="点击上传材料文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.cailiaowenjian" label="材料文件" prop="cailiaowenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.cailiaowenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.cailiaowenjian" label="材料文件" prop="cailiaowenjian">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../djangojyzn7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.cailiaowenjian!=null) {
		this.ruleForm.cailiaowenjian = this.ruleForm.cailiaowenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cheliangcailiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheliangcailiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    cailiaowenjianUploadChange(fileUrls) {
	    this.ruleForm.cailiaowenjian = fileUrls;
    },
  }
};
</script>
