	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundSize":" 100% 100%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20220730/cb2195540cde42b7abf14af25c15da3e.png) no-repeat  center bottom / cover","display":"flex","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="载人数" prop="zairenshu">
					<el-input v-model="ruleForm.zairenshu" placeholder="载人数" clearable  :readonly="ro.zairenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="载人数" prop="zairenshu">
					<el-input v-model="ruleForm.zairenshu" placeholder="载人数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="使用天数" prop="shiyongtianshu">
					<el-input v-model="ruleForm.shiyongtianshu" placeholder="使用天数" clearable  :readonly="ro.shiyongtianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="使用天数" prop="shiyongtianshu">
					<el-input v-model="ruleForm.shiyongtianshu" placeholder="使用天数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="使用时间" prop="shiyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shiyongshijian" label="使用时间" prop="shiyongshijian">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				zairenshu: [
					{ required: true, message: '载人数不能为空', trigger: 'blur' },
				],
				mudedi: [
	...
	computed: {
		...
		zongjiage:{
			get: function () {
				return 1*this.ruleForm.meirizujin*this.ruleForm.shiyongtianshu
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zairenshu'){
							this.ruleForm.zairenshu = obj[o];
							this.ro.zairenshu = true;
							continue;
						}
						if(o=='mudedi'){
