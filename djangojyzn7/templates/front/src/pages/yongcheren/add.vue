...
<div :style='{"border":"1px solid #dfdfdf","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="身份证照" v-if="type!='cross' || (type=='cross' && !ro.shenfenzhengzhao)" prop="shenfenzhengzhao">
            <file-upload
            tip="点击上传身份证照"
            action="file/upload"
            :limit="3"
            ...
            @change="shenfenzhengzhaoUploadChange"
            ></file-upload>
          </el-form-item>
            <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' class="upload" v-else label="身份证照" prop="shenfenzhengzhao">
                <img v-if="ruleForm.shenfenzhengzhao.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.shenfenzhengzhao.split(',')[0]" width="100" height="100">
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shenfenzhengzhao.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="驾照" v-if="type!='cross' || (type=='cross' && !ro.jiazhao)" prop="jiazhao">
            <file-upload
            tip="点击上传驾照"
            action="file/upload"
            :limit="3"
            ...
            @change="jiazhaoUploadChange"
            ></file-upload>
          </el-form-item>
            <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' class="upload" v-else label="驾照" prop="jiazhao">
                <img v-if="ruleForm.jiazhao.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.jiazhao.split(',')[0]" width="100" height="100">
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiazhao.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
...
<script>
  export default {
    data() {
      return {
        ...
        rules: {
          ...
          shenfenzhengzhao: [
            { required: true, message: '身份证照不能为空', trigger: 'blur' },
          ],
          jiazhao: [
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='shenfenzhengzhao'){
              this.ruleForm.shenfenzhengzhao = obj[o].split(",")[0];
              this.ro.shenfenzhengzhao = true;
              continue;
            }
            if(o=='jiazhao'){
              this.ruleForm.jiazhao = obj[o].split(",")[0];
              this.ro.jiazhao = true;
              continue;
            }
          }
        }
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('yongcheren/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('yongcheren/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
      ...
      shenfenzhengzhaoUploadChange(fileUrls) {
          this.ruleForm.shenfenzhengzhao = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
      jiazhaoUploadChange(fileUrls) {
          this.ruleForm.jiazhao = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
