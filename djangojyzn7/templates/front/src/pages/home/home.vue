...
<div class="news" :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"0 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"49%","height":"660px","order":"2"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221027/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat -70px bottom,url(http://codegen.caihongy.cn/20221027/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 400px bottom"}'>
		<span :style='{"fontSize":"24px","color":"#005aad","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>公告资讯</span>
	</div>
...
<div class="lists" :style='{"border":"1px solid #dfdfdf","padding":"0 12px 20px 12px","boxShadow":"1px 2px 3px #eee","margin":"0 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","height":"auto","order":"4"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221027/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat 240px center,url(http://codegen.caihongy.cn/20221027/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 760px center"}'>
	  <span :style='{"fontSize":"24px","color":"#005aad","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>车辆信息展示</span>
	</div>
	...
	<div class="list list3 index-pv1">
		<div class="swiper-container" id="listscheliangxinxi" :style='{"width":"100%","padding":"10px","background":"#fff","height":"auto"}'>
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"0","cursor":"pointer","fontSize":"0","position":"relative","borderRadius":"4px","background":"#fff"}' v-for="(item,index) in cheliangxinxiList" :key="index" @click="toDetail('cheliangxinxiDetail', item)">
					<img :name="item.id" :style='{"border":"1px solid #ddd","width":"216px","borderRadius":"8px","objectFit":"contain","background":"#fff","height":"216px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"border":"1px solid #ddd","width":"216px","borderRadius":"8px","objectFit":"contain","background":"#fff","height":"216px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
					<div class="name line1" :style='{"padding":"0 10px","boxShadow":"1px 1px 1px #ddd","margin":"4px 0 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"8px","textAlign":"center","background":"#f5f5f5","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>{{item.cheliangmingcheng}}</div>
					<div class="name line1" :style='{"padding":"0 10px","boxShadow":"1px 1px 1px #ddd","margin":"4px 0 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"8px","textAlign":"center","background":"#f5f5f5","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>{{item.cheliangleixing}}</div>
					<div class="name line1" :style='{"padding":"0 10px","boxShadow":"1px 1px 1px #ddd","margin":"4px 0 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"8px","textAlign":"center","background":"#f5f5f5","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>{{item.cheliangpinpai}}</div>
					<div class="name line1" :style='{"padding":"0 10px","boxShadow":"1px 1px 1px #ddd","margin":"4px 0 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"8px","textAlign":"center","background":"#f5f5f5","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>每日租金（元）:{{item.meirizujin}}</div>
					<div class="name line1" :style='{"padding":"0 10px","boxShadow":"1px 1px 1px #ddd","margin":"4px 0 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"8px","textAlign":"center","background":"#f5f5f5","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>{{item.zhuangtai}}</div>
            </div>
        </div>
			<!-- 如果需要导航按钮 -->
	...
	<div @click="moreBtn('cheliangxinxi')" :style='{"border":"1px solid #89c2f9","cursor":"pointer","boxShadow":"0px 4px 1px #c7d3de,inset 0px 0px 56px 0px #a0cbf7","margin":"36px auto","borderRadius":"30%","textAlign":"center","left":"47%","background":"#fff","display":"block","width":"120px","lineHeight":"36px","position":"absolute"}'>
		<span :style='{"color":"#0583fc","fontSize":"14px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#0583fc","fontSize":"14px"}' class="el-icon-d-arrow-right"></i>
	</div>
          ...
          let autoSortUrl = "";
			...
			this.$http.get('cheliangxinxi/list', {params: {
				...
				if (res.data.code == 0) {
					...
					this.$nextTick(() => {
						new Swiper ('#listscheliangxinxi', options)
					})
